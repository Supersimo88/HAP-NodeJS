...
var OFFICELIGHT = {
  ...
  setPowerOn: function(on) { 
    ...
    if (on) {
      client.publish('officelight', 'on');
      OFFICELIGHT.powerOn = on;
   	} 
    else {
	    client.publish('officelight','off');
  ...
  setBrightness: function(brightness) {
    ...
    client.publish('officelight/brightness',String(brightness));
    OFFICELIGHT.brightness = brightness;
  },
  setHue: function(hue){
    console.log("Setting light Hue to %s", hue);
    client.publish('officelight/hue',String(hue));
    OFFICELIGHT.hue = hue;
  },
  setSaturation: function(saturation){
    console.log("Setting light Saturation to %s", saturation);
    client.publish('officelight/saturation',String(saturation));
